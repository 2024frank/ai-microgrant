...
- When the source page displays an image for the event, set image_cdn_url to that image's public HTTPS URL. An event without its source image is incomplete for review.
